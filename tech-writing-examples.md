...
I think it can be difficult to judge the quality of documentation unless one knows the domain well. Documentation can look pretty and neat, but still be useless (e.g., it might be inaccurate, or maybe it just doesn't actually help solve any problems for the given audience). And, on the flip side, documentation can be quite rough and unpretty and yet be very successful (e.g., a simple bulletpoint list that is highly focused on addressing an audience's problems). The example projects I've chosen were successful and I'm proud of them, but I fear that their high quality can be easy to miss if one doesn't know the domain well and what specific challenges I was solving. If I'm applying for a job with you, I'd love a chance to walk you through the reasoning that went into these projects, and how I measured success. 
...
* [A guide to understanding the docs site structure and navigation](https://github.com/newrelic/docs-website/blob/develop/src/content/docs/style-guide/writing-docs/processes-procedures/understand-edit-docs-site-structure.mdx): When we switched from a Drupal CMS to a GitHub-based static site implementation, we struggled with some writers being confused about how to edit the site navigation and move docs around. I wrote this guide to help the team better understand the docs site's displayed structure and navigation, its underlying file/folder structure, and how those two dimensions related. 
...
* [A guide to using a branched-install component](https://github.com/newrelic/docs-website/blob/develop/src/content/docs/style-guide/writing-docs/article-templates/intro-branch-install-doc.mdx): This was a guide to help writers use a specific doc component: what we called a "branched install" component. This component allowed readers to select different choices and be shown different install instructions depending on their choices.
